...
// PROJECT DETAIL VIEW
// ============================================
function showProjectDetail(title, category, location, year, size, description) {
    ...
    // Hide the portfolio grid and filter sections
...
function hideProjectDetail() {
    ...
    // Show the portfolio grid and filter sections
